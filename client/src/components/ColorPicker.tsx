...
export const ColorPickerHue = ({
  ...
  return (
    ...
    >
      ...
      <Thumb className="border-primary/50 bg-background focus-visible:ring-ring block h-4 w-4 rounded-full border shadow transition-colors focus-visible:ring-1 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50" />
    </Root>
  );
};
...
export const ColorPickerAlpha = ({
  ...
  return (
    ...
    >
      ...
      >
        <div className="to-primary/50 absolute inset-0 rounded-full bg-gradient-to-r from-transparent" />
...
export const ColorPickerOutput = ({
  ...
  return (
    <Select value={mode} onValueChange={setMode}>
      <SelectTrigger className="!h-8 w-[5rem] shrink-0 text-xs" {...props}>
...
export const ColorPickerFormat = ({
  ...
  if (mode === 'hex') {
    ...
    return (
      <div
        className={cn('relative flex items-center -space-x-px', className)}
        {...props}
      >
        <Input
          type="text"
